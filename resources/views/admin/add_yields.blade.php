            ...
            <div class="row">
               ...
               <section class="col-md-12">
                   ...
                   <div class="col-lg-6 col-md-6">
                        <form method="get" action="/add-yield" data-parsley-validate="" novalidate="">
                            @csrf
                            <!-- START panel-->
                            <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">Add Yield</div>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label">Yield Name</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="weight" required data-parsley-equalto="#id-password" class="form-control">
                                </div>
                            </div>
